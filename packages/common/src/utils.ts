// NOTE: Inlined to avoid circular dependency: common → math → common
...
// Get the current environment mode (works with both Vite and Next.js/Turbopack)
const getEnvMode = () => {
...
export const isTestEnv = () => getEnvMode() === ENV.TEST;

export const isDevEnv = () => getEnvMode() === ENV.DEVELOPMENT;

export const isProdEnv = () => getEnvMode() === ENV.PRODUCTION;
