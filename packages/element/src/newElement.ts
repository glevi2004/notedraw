...
export const newNoteElement = (
  ...
  return {
    ..._newElementBase<ExcalidrawNoteElement>("note", {
      ...opts,
      // Notes have a light background by default
      backgroundColor: opts.backgroundColor || "#f8f9fa",
      strokeColor: opts.strokeColor || "#868e96",
      strokeWidth: opts.strokeWidth ?? 1,
      fillStyle: opts.fillStyle || "solid",
      roughness: opts.roughness ?? 0,
    }),
    noteContent: opts.noteContent || defaultContent,
  };
};
