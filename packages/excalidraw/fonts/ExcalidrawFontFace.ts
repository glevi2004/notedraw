...
export class ExcalidrawFontFace {
  ...
  // Use fallback package name for CDN URL (PKG_NAME/PKG_VERSION only available during npm package build)
  private static readonly ASSETS_FALLBACK_URL = `https://esm.sh/@excalidraw/excalidraw/dist/prod/`;
